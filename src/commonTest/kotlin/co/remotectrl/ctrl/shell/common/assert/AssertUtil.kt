...
class AssertUtil {
    companion object {
        ...
        fun <TAggregate : CtrlAggregate<TAggregate>> assertExecution(
            ...
            val actualValid = (actual as co.remotectrl.ctrl.event.CtrlExecution.Validated)
        ...
        fun <TAggregate : CtrlAggregate<TAggregate>> assertExecution(
            ...
            val actualInvalid = (actualExecution as co.remotectrl.ctrl.event.CtrlExecution.Invalidated)
